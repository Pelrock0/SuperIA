...
<script>
    // Si no hay tema guardado, usa "system" como predeterminado
    if (localStorage.getItem('backpack_theme') === null) {
        localStorage.setItem('backpack_theme', 'light');
    }
</script>
...
@include(backpack_view('inc.theme_styles_aj'))
