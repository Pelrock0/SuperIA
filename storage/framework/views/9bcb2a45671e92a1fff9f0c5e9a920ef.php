<?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($crud->exportButtons()): ?>
    <?php Basset::basset('https://cdn.datatables.net/buttons/3.2.0/js/dataTables.buttons.min.js'); ?>
    <?php Basset::basset('https://cdn.datatables.net/buttons/3.2.0/js/buttons.bootstrap5.min.js'); ?>
    ...
    <?php Basset::basset('https://cdn.datatables.net/buttons/3.2.0/js/buttons.html5.min.js'); ?>
    <?php Basset::basset('https://cdn.datatables.net/buttons/3.2.0/js/buttons.print.min.js'); ?>
    <?php Basset::basset('https://cdn.datatables.net/buttons/3.2.0/js/buttons.colVis.min.js'); ?>
    <script>
    ...
    <?php $__env->startPush('after_styles'); ?>
        <?php Basset::basset('https://cdn.datatables.net/buttons/3.2.0/css/buttons.bootstrap5.min.css'); ?>
    <?php $__env->stopPush(); ?>
<?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
<?php /**PATH I:\proyectos\SuperIA\vendor\backpack\crud\src\resources\views\crud/inc/export_buttons.blade.php ENDPATH**/ ?>