...
<div class="admin-body" style="padding: 32px; max-width: 1280px; margin: 0 auto;">
    ...
    <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 24px; margin-bottom: 32px;">
        <div class="stat-card">
            ...
            <div class="stat-value"><?php echo e(number_format($metrics['users_total'])); ?></div>
        </div>
        <div class="stat-card">
            <div style="display: flex; justify-content: space-between; align-items: flex-start; margin-bottom: 16px;">
            ...
            <div class="stat-value"><?php echo e(number_format($metrics['users_active_7d'])); ?></div>
        </div>
        <div class="stat-card">
            <div style="display: flex; justify-content: space-between; align-items: flex-start; margin-bottom: 16px;">
                <div class="stat-icon" style="background: #c1e8ff;">
                ...
                <span class="stat-badge"><?php echo e($metrics['lists_created_today']); ?> hoy</span>
            </div>
            <div class="stat-label">Listas creadas hoy</div>
            <div class="stat-value"><?php echo e(number_format($metrics['lists_total'])); ?></div>
        </div>
        <div class="stat-card">
            <div style="display: flex; justify-content: space-between; align-items: flex-start; margin-bottom: 16px;">
                ...
                <span class="stat-badge"><?php echo e($metrics['ai_calls_today']); ?> hoy</span>
            </div>
            <div class="stat-label">Llamadas IA (mes)</div>
            <div class="stat-value"><?php echo e(number_format($metrics['ai_calls_month'])); ?></div>
        </div>
    </div>
        ...
        <div class="ai-card">
            ...
            <div style="margin-bottom: 48px;">
                ...
                <div style="display: flex; align-items: baseline; gap: 8px;">
                    <span style="font-size: 48px; font-weight: 800; letter-spacing: -0.025em;">€<?php echo e($metrics['ai_cost_month']); ?></span>
                </div>
            </div>
            <div class="bar-chart">
        ...
        <div class="waitlist-card">
            <div style="display: flex; justify-content: space-between; align-items: flex-start; margin-bottom: 32px;">
                ...
                <div style="background: #f2f4f6; padding: 8px 16px; border-radius: 16px; text-align: right;">
                    <span style="font-size: 24px; font-weight: 900; color: #002736;"><?php echo e($metrics['waitlist_pending']); ?></span>
                    <span style="display: block; font-size: 10px; color: #71787d; text-transform: uppercase; font-weight: 700;">En espera</span>
                </div>
            </div>
            <div style="margin-bottom: 24px;">
                <a href="<?php echo e(backpack_url('waitlist-entry')); ?>" style="color: #002736; font-size: 14px; font-weight: 700; text-decoration: none;">Ver todos los usuarios →</a>
            </div>
            <a href="<?php echo e(backpack_url('waitlist-entry')); ?>" class="invite-btn" style="text-decoration: none;">
    ...
    <div style="display: flex; gap: 12px; flex-wrap: wrap; margin-bottom: 32px;">
        <a href="<?php echo e(backpack_url('user')); ?>" class="quick-link">
            <span class="material-symbols-outlined" style="font-size: 18px;">group</span> Usuarios
        </a>
        <a href="<?php echo e(backpack_url('ai-usage')); ?>" class="quick-link">
            <span class="material-symbols-outlined" style="font-size: 18px;">psychology</span> Consumo IA
        </a>
        <a href="<?php echo e(backpack_url('waitlist-entry')); ?>" class="quick-link">
    ...
    <div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 24px;">
        ...
        <div class="system-card">
            ...
            <div>
                ...
                <div style="font-size: 12px; color: #71787d;">MySQL · <?php echo e(number_format($metrics['lists_total'])); ?> listas · <?php echo e(number_format($metrics['users_total'])); ?> usuarios</div>
            </div>
        </div>
        <div class="system-card">
            <div class="system-icon">
            ...
            <div>
                ...
                <div style="font-size: 12px; color: #71787d;"><?php echo e(number_format($metrics['ai_calls_month'])); ?> llamadas/mes · €<?php echo e($metrics['ai_cost_month']); ?> coste</div>
            </div>
        </div>
    </div>
</div>
...
<?php echo $__env->make(backpack_view('blank'), array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH I:\proyectos\SuperIA\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>