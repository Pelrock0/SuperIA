<?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($crud->get('list.detailsRow')): ?>
    <script>
        ...
        buttons.forEach(button => {
            ...
            newButton.addEventListener('click', function(e) {
                ...
                if (row.child.isShown()) {
                    ...
                    const url = '<?php echo e(url($crud->route)); ?>/' + entryId + '/details';
...
<?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?><?php /**PATH I:\proyectos\SuperIA\vendor\backpack\crud\src\resources\views\crud/inc/details_row_logic.blade.php ENDPATH**/ ?>