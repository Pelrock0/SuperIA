...
<?php Basset::basset("https://cdn.datatables.net/2.1.8/js/dataTables.min.js"); ?>
<?php Basset::basset("https://cdn.datatables.net/2.1.8/js/dataTables.bootstrap5.min.js"); ?>
<?php Basset::basset("https://cdn.datatables.net/responsive/3.0.3/js/dataTables.responsive.min.js"); ?>
<?php Basset::basset('https://cdn.datatables.net/fixedheader/4.0.1/js/dataTables.fixedHeader.min.js'); ?>
...
<?php $__env->startPush('before_styles'); ?>
    <?php Basset::basset('https://cdn.datatables.net/2.1.8/css/dataTables.bootstrap5.min.css'); ?>
    <?php Basset::basset("https://cdn.datatables.net/responsive/3.0.3/css/responsive.dataTables.min.css"); ?>
    <?php Basset::basset('https://cdn.datatables.net/fixedheader/4.0.1/css/fixedHeader.dataTables.min.css'); ?>
<?php $__env->stopPush(); ?>
...
function formatActionColumnAsDropdown(tableId) {
    ...
    $('#' + tableId + ' tbody tr').each(function (i, tr) {
        ...
        if (dropdownItems.length > 0) {
            ...
            actionCell.prepend('<button class="btn btn-sm px-2 py-1 btn-outline-primary dropdown-toggle actions-buttons-column" type="button" aria-expanded="false"><?php echo e(trans("backpack::crud.actions")); ?></button>');
...
<?php /**PATH I:\proyectos\SuperIA\vendor\backpack\crud\src\resources\views\crud/components/datatable/datatable_logic.blade.php ENDPATH**/ ?>