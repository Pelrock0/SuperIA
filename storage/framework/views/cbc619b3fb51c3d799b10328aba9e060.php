<nav class="navbar navbar-expand-lg navbar-filters mb-0 py-0 shadow-none" data-component-id="<?php echo e($componentId ?? ''); ?>">
    
    <a class="nav-item d-none d-lg-block my-auto"><span class="la la-filter"></span></a>
    <button class="navbar-toggler ms-3"
            type="button"
            data-toggle="collapse"  
            data-target="#bp-filters-navbar" 
            data-bs-toggle="collapse"   
            data-bs-target="#bp-filters-navbar"   
            aria-controls="bp-filters-navbar"
            aria-expanded="false"
            aria-label="<?php echo e(trans('backpack::crud.toggle_filters')); ?>">
    ...
    <div class="collapse navbar-collapse" id="bp-filters-navbar">
        <ul class="nav navbar-nav">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $crud->filters(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $filter): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php echo $__env->first($filter->getNamespacedViewWithFallbacks(), array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        <li class="nav-item"><a href="#" class="nav-link remove_filters_button <?php echo e(count(Request::input()) != 0 ? '' : 'invisible'); ?>"><i class="la la-eraser"></i> <?php echo e(trans('backpack::crud.remove_filters')); ?></a></li>
        </ul>
    </div>
</nav>
  
<?php $__env->startPush('after_scripts'); ?>
    <?php Basset::basset('https://cdn.jsdelivr.net/npm/urijs@1.19.11/src/URI.min.js'); ?>
    <script>
...
<?php $__env->stopPush(); ?>
<?php /**PATH I:\proyectos\SuperIA\vendor\backpack\crud\src\resources\views\crud/inc/filters_navbar.blade.php ENDPATH**/ ?>